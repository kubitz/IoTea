...
def predict_teacup_temp(current_temp, final_temp):
    ...
    time_left = - (AVERAGE_TEACUP_CONSTANT / AVERAGE_ROOM_TEMP) * math.log(
        (float(final_temp) - AVERAGE_ROOM_TEMP) / (float(current_temp) - AVERAGE_ROOM_TEMP))
    return time_left
